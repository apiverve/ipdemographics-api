...
class TestIpdemographicsAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = IpdemographicsAPIClient(self.api_key)

    @patch('apiverve_ipdemographics.apiClient.requests.get')
