...
namespace APIVerve.API.IPDemographics
{
    ...
    /// <summary>
    /// Client for the IPDemographics API
    /// </summary>
    public class IPDemographicsAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/ipdemographics";
        ...
        public IPDemographicsAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public IPDemographicsAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public IPDemographicsAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, IPDemographicsQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(IPDemographicsQueryOptions options)
        {
        ...
        public ResponseObj Execute(IPDemographicsQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(IPDemographicsQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(IPDemographicsQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(IPDemographicsQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(IPDemographicsQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(IPDemographicsQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(IPDemographicsQueryOptions options)
        {
