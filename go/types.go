// Package ipdemographics provides a Go client for the IP Demographics API.
//
// For more information, visit: https://apiverve.com/marketplace/ipdemographics?utm_source=go&utm_medium=readme
package ipdemographics
...
// Request contains the parameters for the IP Demographics API.
//
// Parameters:
//   - ip (required): string - IPv4 or IPv6 address [format: ip]
type Request struct {
...
// ResponseData contains the data returned by the IP Demographics API.
...
// DemographicsData represents the demographics object.
type DemographicsData struct {
	Population int `json:"population"`
	MedianAge float64 `json:"medianAge"`
	MedianHouseholdIncome int `json:"medianHouseholdIncome"`
	PerCapitaIncome int `json:"perCapitaIncome"`
