...
const (
	baseURL        = "https://api.apiverve.com/v1/ipdemographics"
	defaultTimeout = 30 * time.Second
)

// Client is the IP Demographics API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new IP Demographics API client.
...
// Execute makes a request to the IP Demographics API with typed parameters.
//
