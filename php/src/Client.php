...
namespace APIVerve\Ipdemographics;
...
/**
 * Client for the IP Demographics API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/ipdemographics?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/ipdemographics';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\IpdemographicsClient] {$message}\n";
        }
    }
}
