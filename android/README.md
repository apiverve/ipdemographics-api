...
```gradle
dependencies {
    implementation 'com.github.apiverve:ipdemographics-api:1.1.13'
}
```
...
```java
import com.apiverve.ipdemographics.IPDemographicsAPIClient;
import com.apiverve.ipdemographics.APIResponse;
import com.apiverve.ipdemographics.APIException;

// Initialize the client
IPDemographicsAPIClient client = new IPDemographicsAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/ipdemographics](https://docs.apiverve.com/ref/ipdemographics)
...
- **Documentation:** [https://docs.apiverve.com/ref/ipdemographics](https://docs.apiverve.com/ref/ipdemographics)
- **Issues:** [GitHub Issues](https://github.com/apiverve/ipdemographics-api/issues)
